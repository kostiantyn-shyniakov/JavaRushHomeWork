...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        float n11 = Float.parseFloat(n1);
        if (n11%5>=0 && n11%5<3) System.out.println("зеленый");//напишите тут ваш код
        if (n11%5>=3 && n11%5<4) System.out.println("желтый");
        if (n11%5>=4 && n11%5<5) System.out.println("красный");
