...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament next : apartaments)
        {
            if (next instanceof Apt1Room)
            {
                Apt1Room room1=(Apt1Room) next;
                room1.clean1Room();
            }

            if (next instanceof Apt2Room)
            {
                Apt2Room room1=(Apt2Room) next;
                room1.clean2Rooms();
            }

            if (next instanceof Apt3Room)
            {
                Apt3Room room1=(Apt3Room) next;
                room1.clean3Rooms();
            }
        }
    }
